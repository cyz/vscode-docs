...
The following video shows how agent sessions continue running after you close a folder and stay synchronized across VS Code windows, the Agents window, the web, and multiple machines.
